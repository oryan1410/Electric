...
function Home() {
  ...
  return (
    <Box id={'electricApp'} sx={{ direction: 'rtl', fontFamily: 'Roboto, sans-serif', background: 'linear-gradient(135deg, #0a2342 0%, #19747e 100%)', minHeight: '100vh', color: 'white' }}>
      {/* Hero Section */}
      <Box sx={{ background: 'linear-gradient(120deg, #0a2342 0%, #19747e 100%)', color: 'text.primary', py: { xs: 13, md: 12 }, px: { xs: 4, md: 2 } }}>
      ...
      <Box sx={{ py: 5, px: 2, background: '#f3f6fa', color: '#1a2636' }}>
        <Container maxWidth="xxl">
      ...
      {/* Image Carousel */}
      <Box sx={{ py: 5, background: '#eaf1f6', color: '#1a2636' }}>
        <Container maxWidth="xxl">
      ...
      <Box sx={styles.contactBox}>
        <Container maxWidth="xxl">
          <Grid container textAlign={'center'} alignContent={'center'} justifyContent={'center'} direction="column">
            ...
            <p>טלפון: &nbsp;
              <a href="tel:0508689068" style={styles.contactLink}>
                050-8689068
              </a>
            </p>
            <p>מייל:&nbsp;
              <a href="mailto:hanoch2277@gmail.com" style={styles.contactLink}>
...
const styles = {
  contactBox: {
     background: 'linear-gradient(180deg, #232f3e 0%, #1a2636 100%)', color: 'white', py: { xs: 6, md: 10 }
  },
  contactLink: {
    color: '#21cbf3',
    textDecoration: 'none',
